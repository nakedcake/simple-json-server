...
const call = () => {
  ...
  for (let i = 0; i < length; i++) {
    ...
    const product = {
      ...
      description:
        'Тому, кто много двигается, необходим корм, который предоставляет много энергии. Поэтому есть специальный корм для кошек, имеющих доступ на улицу и тех которые активны дома. Он оптимально обеспечивает кошку всеми необходимыми питательными веществами, после обстоятельной ревизии своей территории. Happy Cat «Пастбищный ягненок» предоставляет маленькому искателю приключений все ценные ингредиенты. Happy Cat «Пастбищный ягненок» содержит нежное и легко усваиваемое мясо ягненка и птицы. Изысканная без рыбная рецептура была специально разработана для активных кошек, это означает: калорийность была приведена в соответствие с потребностями физически активных кошек. Все важные компоненты, основанные на революционном концепте ALL IN ONE, которые нужны кошкам для активного образа жизни так же содержатся и в этом корме Happy Cat, а именно: профилактика скопления шерсти, таурин, контроль за уровнем pH в мочевой системе уход да полостью рта, Омега 3 и Омега 6 для кожи и шерсти, гарантированная вкусовая привлекательность, большое количество животного протеина и Happy Cat Natural Life Concept. В состав данного корма входит настоящий новозеландский моллюск и льняное семя для поддержки суставов и иммунитета что является хорошим заботой по отношению к активным кошкам. ',
    };
